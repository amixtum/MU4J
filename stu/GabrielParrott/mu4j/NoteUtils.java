...
public class NoteUtils {
	...
	// frequency constants
	private static final double HalfStepCo = Math.pow(2.00, 1.00 / 12.00);
	private static final double CFreq = 440.00 * Math.pow(HalfStepCo, 3.00);
	...
	public static Quality getRelationship(Note baseNote, Note compareNote) {
		return getRelationship(baseNote.getNoteName(),
				compareNote.getNoteName());
	}
